...
const english: Record<string, string> = {
  ...
  "此邮件将移至已删除文件夹。": "This message will be moved to Trash.",
  "此邮件将被永久删除，操作无法撤销。": "This message will be permanently deleted. This cannot be undone.",
  "此邮件将从当前文件夹移动到归档。": "This message will be moved from the current folder to Archive.",
  "已删除": "Trash",
  "管理": "MANAGE",
  "账号管理": "Accounts",
